...
Kanso is tested against `hermes-webui` tag `v0.51.85`, peeled commit `f1d399b437c1ca7fe4b6d2093aebe334c32f34a3`.
...
Implemented now:
- `KansoTests/APIClientTests.swift` contains a contract-readiness matrix for every app-used `Endpoint` case.
