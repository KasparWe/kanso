    ...
    var body: some View {
        Group {
            ...
            case .incompatibleContract:
                unavailableContent(
                    title: String(localized: "This server's Kanban response is incompatible with Kanso."),
    ...
    private func dispatchSummary(_ dispatch: KanbanDispatchState) -> some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            if dispatch.phase == .outcomeUncertain {
                Text("Kanso refreshed the Board, but cannot prove whether workers started. Review the current Board before running Dispatcher again.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
                ...
                Text("The server refused this Dispatcher request. Kanso did not retry it.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
    ...
    var body: some View {
        List {
            ...
            Section {
                ...
                Text("Browsing a Board stays local to Kanso. Making a Board active changes shared server state.")
            }
        }
        ...
        .alert(
            ...
            Text("Kanso cannot restore an archived Board in-app.")
        }
        .alert(
            "Make Active Board",
            isPresented: Binding(
