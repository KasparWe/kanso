...
enum KansoDeepLink {
    static var scheme: String {
        Bundle.main.object(forInfoDictionaryKey: "KansoURLScheme") as? String
            ?? "kanso"
    }
    ...
    /// `kanso://new-chat` (scheme follows the active build, e.g. `-branch`).
    ...
    /// `kanso://new-chat-voice` (scheme follows the active build, e.g. `-branch`).
    ...
    /// `kanso://new-chat-profile?profile=<name>` (scheme follows the active build).
