...
final class LocalizationCatalogTests: XCTestCase {
    ...
    private func resourceURL(_ relativePath: String) -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()   // KansoTests
            .deletingLastPathComponent()   // repo root
            .appendingPathComponent(relativePath)
    }

    private func catalogURL() -> URL {
        // .../KansoTests/LocalizationCatalogTests.swift
        //   -> repo root -> Kanso/Resources/Localizable.xcstrings
        resourceURL("Kanso/Resources/Localizable.xcstrings")
    }
    ...
    func testAppShortcutPhrasesHaveDedicatedCatalogEntries() throws {
        let url = resourceURL("Kanso/Resources/AppShortcuts.xcstrings")
    ...
    func testKanbanBoardManagementCopyIsLocalizedInEveryShippedLanguage() throws {
        ...
        let boardKeys = [
            ...
            "Browse Board: %@",
            "Browsing",
            "Browsing a Board stays local to Kanso. Making a Board active changes shared server state.",
            "Check Result",
            "Choose Board",
            "Creating a Board does not make it active.",
            "Kanso cannot restore an archived Board in-app.",
            "Icon",
            "Make Active Board",
    ...
    func testKanbanDispatcherCopyIsLocalizedInEveryShippedLanguage() throws {
        ...
        let dispatcherKeys = [
            ...
            "Group by Profile",
            "Kanso refreshed the Board, but cannot prove whether workers started. Review the current Board before running Dispatcher again.",
            ...
            "Spawned",
            "The server refused this Dispatcher request. Kanso did not retry it.",
