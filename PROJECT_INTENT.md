...
Kanso is a native iPhone control surface for a self-hosted Hermes AI agent stack. The phone is the control plane and review surface; the macOS/server-side Hermes WebUI stack is the execution plane.
